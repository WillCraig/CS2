...
int main () {
    {
        ...
        // this is an example for multiply.cpp

        bigint left("989879834546773419900000798730000");
        bigint right("6989879787987700054351292345000005200000001");
        bigint result;
        ...
        // Verify
        assert(left   ==  "989879834546773419900000798730000");
        assert(right  ==   "6989879787987700054351292345000005200000001");
        assert(result == "6919141048035100200210975525033830928251145710609352748627573296000798730000");
    }
    {
        //------------------------------------------------------
        // Setup fixture
